public class ListPesanan {
    ...
    //Method untuk mencari pesanan berdasarkan kode
    public void cari(int kode) {
        ...
        while (temp != null) {
            ...
            if (temp.kodePesanan == kode) {
                System.out.println("Pesanan ditemukan:");
                System.out.println("Kode  : " + temp.kodePesanan);
                System.out.println("Nama  : " + temp.namaPesanan);
        ...
        System.out.println("Pesanan dengan kode " + kode + " tidak ditemukan.");
    }
}